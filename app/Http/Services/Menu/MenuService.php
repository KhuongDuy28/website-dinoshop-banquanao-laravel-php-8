...
class MenuService
{
    ...
    public function update($request, $menu): bool // $menu chính là data của mình
    {
    ...
    {
        return Menu::where('id', $id)->where('active', 1)->firstOrFail(); // khi ta đưa cái id Menu vào, kiểm tra có thì oke không thì sẽ báo lỗi 404
    }
