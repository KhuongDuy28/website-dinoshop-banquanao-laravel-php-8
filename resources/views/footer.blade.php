	...
	<footer class="bg3 p-t-75 p-b-32">
		<div class="container">
			<div class="row">
				...
				<div class="col-sm-6 col-lg-3 p-b-50" style="padding-left: 80px" >
					<h4 class="stext-301 cl0 p-b-30">
						SẢN PHẨM
					</h4>
				...
				<div class="col-sm-6 col-lg-3 p-b-50">
					...
					<p class="stext-107 cl7 size-201">
						VPGD: DINO SHOP - Số 50, Ngõ 66A Triều Khúc, Thanh Xuân, Hà Nội
						<br>
						Hotline: 0965218207
					</p>
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | Made with <i class="fa fa-heart-o" aria-hidden="true"></i> by <a class="stext-107 cl7 hov-cl1 trans-04" style="color: #717fe0" href="https://colorlib.com" target="_blank">NGUYỄN KHƯƠNG DUY</a> 
