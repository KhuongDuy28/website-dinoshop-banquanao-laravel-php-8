                                        ...
                                        <div class="size-204 respon6-next">
                                            <div class="rs1-select2 bor8 bg0">
                                                <select class="js-select2 select2-hidden-accessible" name="time" tabindex="-1" aria-hidden="true">
                                                    {{-- <option class="sizes">Lựa chọn</option>
                                                    <option class="sizes">Size S</option>
                                                    <option class="sizes">Size M</option>
                                                    <option class="sizes">Size L</option>
                                                    <option class="sizes">Size XL</option>
                                                    <option class="sizes">Size 2XL</option> --}}
                                                </select>
