...
@section('content')
    <div class="customer" style="margin: 0px 25px; padding-top: 15px;border: 1px solid gainsboro"> 
        <ul>
    ...
    <div class="carts" style="margin: 0px 25px; padding-top: 15px;border: 1px solid gainsboro">
        @php $total = 0; @endphp
        <table class="table">
            <tbody>
            <tr class="table_head">
