        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                ...
                <div style="width: 100%;">
                    ...
                    <input type="text" class="form-control" id="exampleFormControlInput1" name="name" value="{{ $slider->name }}" placeholder="Nhập tiêu đề">
                </div>

                <div class="text-silder" style="width: 100%;">
                    <label for="exampleFormControlInput1" class="form-label">Đường dẫn</label>
                    <input type="text" class="form-control" id="exampleFormControlInput1" name="url" value="{{ $slider->url }}">
                </div>
                ...
                <div class="mb-3">
                    ...
                    <div id="image_show">
                        <a href="{{ $slider->thumb }}" target="_blank">
                            <img src="{{ $slider->thumb }}" alt="" height="70px" width="auto">
                        </a>
                    </div>
                ...
                <div class="col-md">
                    ...
                    <div class="form-check mt-3">
                        <input name="active" class="form-check-input" type="radio" value="1" id="active" {{ $slider->active == 1 ? 'checked = ""' : '' }}>
                        <label class="form-check-label" for="active"> Có </label>
                    </div>
                    <div class="form-check">
                        <input name="active" class="form-check-input" type="radio" value="0" id="no_active" {{ $slider->active == 0 ? 'checked = ""' : '' }}>
